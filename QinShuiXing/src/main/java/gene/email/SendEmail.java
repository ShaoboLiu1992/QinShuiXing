...
public class SendEmail {
    ...
    public static void sendEmail(String toEamil, String title, String content, String form) throws Exception {
        Map<String,String> map= new HashMap<String,String>();
        SendEmail mail = new SendEmail("lsb@qigene.cn","uEM57D5qci5yX11a");
